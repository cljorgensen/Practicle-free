...
<script>
    $(document).ready(function() {
        <?php initiateMediumViewTableHistoryTables("customerlog"); ?>
        <?php initiateMediumViewTableHistoryTables("TableDocuments") ?>
        <?php initiateMediumViewTableHistoryTables("TableInvoices") ?>
        <?php initiateSimpleViewTable("fileuploads") ?>
        <?php initiateSimpleViewTable("tableusersincompany") ?>
        <?php initiateSimpleViewTable("tablebsincompany") ?>
