...
<head>
  ...
  <!-- CSS Files -->
  <link id="pagestyle" href="./assets/css/material-dashboard.css?v=<?php echo $Version ?>" rel="stylesheet" />
  <link id="pagestyle" href="./assets/js/DataTables/datatables.min.css?v=<?php echo $Version ?>" rel="stylesheet" />
  <link rel="stylesheet" href="./assets/js/jquery-ui-1.13.2/jquery-ui.min.css?v=<?php echo $Version ?>">
  <!-- JQuery -->
  <script src="./assets/js/core/jquery-3.7.1.min.js?v=<?php echo $Version ?>"></script>
  <!-- JQuery UI -->
  <script src="./assets/js/jquery-ui-1.13.2/jquery-ui.min.js?v=<?php echo $Version ?>"></script>
  <!-- Material sweet alerts -->
  <script src="./assets/js/plugins/sweetalert2.min.js?v=<?php echo $Version ?>"></script>
  <!--  Notifications Plugin -->
  <script src="./assets/js/plugins/bootstrap-notify.js?v=<?php echo $Version ?>"></script>
  <link rel="stylesheet" href="./assets/css/toastr.css?v=<?php echo $Version ?>">
  <script src="./assets/js/plugins/toastr.min.js?v=<?php echo $Version ?>"></script>
  <!-- Core JS Files -->
  <script src="./assets/js/DataTables/datatables.min.js?v=<?php echo $Version ?>"></script>
  <script src="./assets/js/plugins/moment.min.js?v=<?php echo $Version ?>"></script>
  <script src="./assets/js/core/popper.min.js?v=<?php echo $Version ?>"></script>
  <script src="./assets/js/core/bootstrap.min.js?v=<?php echo $Version ?>"></script>
  <!-- DropZone -->
  <link href="./assets/css/dropzone.css?v=<?php echo $Version ?>" type="text/css" rel="stylesheet" />
  <script src="./assets/js/dropzone.js?v=<?php echo $Version ?>"></script>
  <!-- spotlight image viewer -->
  <script src="./assets/js/spotlight.bundle.js?v=<?php echo $Version ?>"></script>
  <!-- Include Select2 CSS -->
  <link rel="stylesheet" href="./assets/css/select2.css?v=<?php echo $Version ?>" />
  <link rel="stylesheet" href="./assets/css/select2-bootstrap-5-theme.min.css?v=<?php echo $Version ?>" />
  <!-- Include Select2 JS -->
  <script src="./assets/js/select2.full.min.js?v=<?php echo $Version ?>"></script>
</head>
...
<script src="./assets/js/ckeditor5_superbuild/ckeditor.js?v=<?php echo $Version ?>"></script>
<script src="./jspracticle/initiators<?php echo $min ?>.js?v=<?php echo $Version ?>"></script>
<script src="./jspracticle/functions<?php echo $min ?>.js?v=<?php echo $Version ?>"></script>
<script src="./jspracticle/functions_cmdb<?php echo $min ?>.js?v=<?php echo $Version ?>"></script>
<script src="./jspracticle/functions_itsm<?php echo $min ?>.js?v=<?php echo $Version ?>"></script>
<script src="./jspracticle/functions_forms<?php echo $min ?>.js?v=<?php echo $Version ?>"></script>
<script src="./jspracticle/functions_project<?php echo $min ?>.js?v=<?php echo $Version ?>"></script>
<script src="./jspracticle/functions_news<?php echo $min ?>.js?v=<?php echo $Version ?>"></script>
    ...
    <div class="collapse navbar-collapse w-auto h-auto" id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        if (!empty($_SESSION['LeaderOfArray'])) { ?>
          ...
          <li class="nav-item">
            <a data-bs-toggle="collapse" href="#managers" class="nav-link text-white" aria-controls="managers" role="button" aria-expanded="false">
              <i class="fa-solid fa-people-roof"></i>
              <span class="nav-link-text ms-2 ps-1"><?php echo _("Management functions"); ?></span>
            </a>
            <div class="collapse" id="managers">
              <ul class="nav">
                <?php
                $menuItems = array(
                  ucfirst($functions->translate("Timeregistrations")) => "./manager_timeregistrations.php",
                  ucfirst($functions->translate("Activity Stream")) => "./activitystream.php"
                );
