...
<script>
    $(document).ready(function() {
        <?php initiateAdvancedViewTable("TableMyTickets"); ?>
        <?php initiateAdvancedViewTable("TeamTickets"); ?>
        <?php initiateAdvancedViewTable("TableOverdueTickets"); ?>
        <?php initiateAdvancedViewTable("TableSoonOverdueTickets"); ?>
    });
</script>
