...
<script>
	$(document).ready(function() {
		<?php initiateAdvancedReportingTable("TableTeam"); ?>
		<?php initiateAdvancedReportingTable("TableTeams"); ?>
		<?php initiateAdvancedReportingTable("TableEmployees"); ?>
		<?php initiateAdvancedReportingTable("TableCompanies"); ?>
		<?php initiateAdvancedReportingTable("TableContacts"); ?>
