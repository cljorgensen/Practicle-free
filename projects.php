...
<script>
	$(document).ready(function() {
		<?php initiateAdancedViewTable("TableProjects"); ?>
	});
</script>
<div class="row">
								...
								<tr class='text-sm text-secondary mb-0'>
									<?php
										if(!empty($ProjectID)){
											...
											?>
											<td data-bs-toggle="tooltip" data-bs-title="<?php echo _("Project ID: ") . $ProjectID; ?>"><a href="projects_view.php?projectid=<?php echo $ProjectID ?>"><?php echo $row['Name']; ?></a></td>
											<td>
												<?php echo "<a href=\"projects_view.php?projectid=$ProjectID\" title=\"" . _("Open") . "\"><span class=\"badge badge-pill bg-gradient-info\"><i class=\"fas fa-folder-open\"></i></span></a><a href='javascript:runModalEditProject($ProjectID);' title=\"" . _("View") . "\"><span class='badge badge-pill bg-gradient-success'><i class='fa-solid fa-pen-to-square'></i></span></a>"; ?>
											</td>
											<td>
