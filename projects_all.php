...
<div class="row">
  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
    <div class="card-group">
      <div class="card">
        <div class="card-header card-header-projects"><i class="fas fa-project-diagram fa-lg"></i> <?php echo _("Open Projects"); ?>
          <div class="float-end">
        ...
        <div class="card-body">
          ...
          <script>
            $(document).ready(function() {
              <?php initiateAdvancedViewTable("TableProjects"); ?>
            });
          </script>
          <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <table id="TableProjects" class="table table-responsive table-borderless table-hover" cellspacing="0">
              ...
              $sql = "SELECT projects.ID, projects.Name, projects.Start, projects.Progress, projects.Status, projects_statuscodes.StatusName, projects.Deadline, CONCAT(users.firstname,' ',users.lastname,' (',users.username,')') AS FullName, projects.EstimatedBudget, 
              ...
              WHERE projects.Status NOT IN ('7','8')";
              ...
              <tbody>
                <?php while ($row = mysqli_fetch_array($result)) { ?>
                  <tr class='text-sm text-secondary mb-0'>
                    ...
                    <td data-bs-toggle="tooltip" data-bs-title="<?php echo ROUND($row['ProjectProgress'], 0); ?>%">
                      <div class="progress">
                        <div class="progress-bar bg-success" role="progressbar" aria-valuenow="<?php echo $row['ProjectProgress']; ?>" aria-valuemin="0" aria-valuemax="100" style="width:<?php echo $row['ProjectProgress']; ?>%">
                        </div>
                      </div>
                    </td>
